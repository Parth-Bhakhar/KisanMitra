...
function loadStates() {
    const selectedCountryCode = 'IN'; // Assuming you want to load states only for India
...
function loadCities() {
    const selectedCountryCode = 'IN'; // Assuming you want to load cities only for India
